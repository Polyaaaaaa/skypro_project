...
def test_get_list_of_transactions() -> None:
    assert (
        get_list_of_transactions("C:/Users/Student Free/PychgfarmProjects/pythonProject2/data/operations.json") == []
    )
    assert get_list_of_transactions("C:/Users/Student Free/PycharmProjects/pythonProject2/data/operations.json") == [
        {
            "id": 441945886,
            "state": "EXECUTED",
